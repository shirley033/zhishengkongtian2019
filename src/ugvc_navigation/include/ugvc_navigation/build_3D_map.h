...
ugvc_navigation::flight_command flight_command_msg;
size_t last_wall_distance;
size_t current_wall_distance;
size_t num_window_passed;

std_msgs::Int8 action_command_msgs;