...
void build_3D_map::cloud_cb (const sensor_msgs::PointCloud2ConstPtr& input) 
{
  ...
  for(i=uu_uav;i<globalMapWidth;i++)
  {
    ...
    if(num_obstacle >10) //若是墙，则该行不少于20 change1 20->10
    {
  ...
  for(size_t ww_temp = 0; ww_temp<globalMapHeight; ww_temp++)
  {
    for(size_t j=0; j<globalMapLongth; j++)
   {
      ...
      {
          obstacle_front_map.maparry[uu_wall_min+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] = 1;
  ...
  for(size_t ww_temp=0; ww_temp<globalMapHeight; ww_temp++)
  {
    ...
    for(size_t vv_temp=0; vv_temp<globalMapLongth-20; vv_temp++) //vv_temp设置为了防止数组越界
    {
      ...
      if(obstacle_front_map.maparry[uu_wall_min+vv_temp*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) //找到当前的障碍
      {
        if(obstacle_front_map.maparry[uu_wall_min+(vv_temp+1)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&      // 该障碍的右边为空,且长度为5以上，且右边第7~8个有障碍
        obstacle_front_map.maparry[uu_wall_min+(vv_temp+2)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&
        obstacle_front_map.maparry[uu_wall_min+(vv_temp+11)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&
        obstacle_front_map.maparry[uu_wall_min+(vv_temp+18)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 &&
        obstacle_front_map.maparry[uu_wall_min+(vv_temp+19)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 &&
        obstacle_front_map.maparry[uu_wall_min+(vv_temp+20)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) 
        {
            break_start_index = vv_temp+1;
            //CHANGE1
                              
            if(obstacle_front_map.maparry[uu_wall_min+(vv_temp+12)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&
            obstacle_front_map.maparry[uu_wall_min+(vv_temp+13)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) //假设窗户宽度为6
            {
              ROS_INFO("break 14");
              break_stop_index = vv_temp+12;
            }
            else if(obstacle_front_map.maparry[uu_wall_min+(vv_temp+13)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&
            obstacle_front_map.maparry[uu_wall_min+(vv_temp+14)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) //假设窗户宽度为6
            {
              break_stop_index = vv_temp+13;
              ROS_INFO("break 15");
            }            
            else if(obstacle_front_map.maparry[uu_wall_min+(vv_temp+14)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&
            obstacle_front_map.maparry[uu_wall_min+(vv_temp+15)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) //假设窗户宽度为6
            {
              ROS_INFO("break 14");
              break_stop_index = vv_temp+14;
            }
            else if(obstacle_front_map.maparry[uu_wall_min+(vv_temp+15)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&
            obstacle_front_map.maparry[uu_wall_min+(vv_temp+16)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) //假设窗户宽度为6
            {
              break_stop_index = vv_temp+15;
              ROS_INFO("break 15");
            }
            else if(obstacle_front_map.maparry[uu_wall_min+(vv_temp+16)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&
            obstacle_front_map.maparry[uu_wall_min+(vv_temp+17)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) //假设窗户宽度为7
            {
              break_stop_index = vv_temp+16;
              ROS_INFO("break 16");
            }
            else if(obstacle_front_map.maparry[uu_wall_min+(vv_temp+17)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&
            obstacle_front_map.maparry[uu_wall_min+(vv_temp+18)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) //假设窗户宽度为7
            {
              break_stop_index = vv_temp+17;
              ROS_INFO("break 17");
            }            
            else if(obstacle_front_map.maparry[uu_wall_min+(vv_temp+18)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 0 &&
            obstacle_front_map.maparry[uu_wall_min+(vv_temp+19)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) //假设窗户宽度为7
            {
            ...
            {
              if(obstacle_front_map.maparry[uu_wall_min+(break_start_index-temp_left)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1)
                left_obstacle_count++;
                else
                break;
            ...
            if(break_stop_index>0)
              ...
              {
                if(obstacle_front_map.maparry[uu_wall_min+temp_right*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1)
      ...
      if(break_start_index!=0)
      {
        ...
        if(vv_temp >= break_start_index && vv_temp <= break_stop_index)
          window_front_map.maparry[uu_wall_min+vv_temp*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] = 1;
  ...
  {
    if(!flight_command_msg.front_wall_reach && !flight_command_msg.front_wall_too_near)
      action_command_msgs.data=FORWARD;
    else if(flight_command_msg.front_wall_reach)
    {
      ...
      {
        if(window_average_vv>=49 && window_average_vv<=51)
        {
          int window_up=0;
          int window_down=0;
          for(size_t w=ww_uav; w<globalMapHeight;w++)
          {
            if(obstacle_front_map.maparry[uu_wall_min+vv_uav*globalMapWidth+w*globalMapLongth*globalMapLongth]==0)
              window_up++;
            else
            {
              if(window_up>0)
          ...
          if(window_up-window_down>2)
            action_command_msgs.data=UP;
          else if (window_up-window_down<-2)
  ...
  for(size_t ww_temp = 0; ww_temp<globalMapHeight; ww_temp++)
  {
    for(size_t j=0; j<globalMapLongth; j++)
   {
      ...
      mazemap.maparry[(uu_wall_start+3)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||
      mazemap.maparry[(uu_wall_start+4)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 || 
      mazemap.maparry[(uu_wall_start+5)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||
      mazemap.maparry[(uu_wall_start+6)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||
      mazemap.maparry[(uu_wall_start+7)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||
      mazemap.maparry[(uu_wall_start+8)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||            
      mazemap.maparry[(uu_wall_start-1)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||
      mazemap.maparry[(uu_wall_start-2)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||
      mazemap.maparry[(uu_wall_start-3)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||
      mazemap.maparry[(uu_wall_start-4)+j*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||
