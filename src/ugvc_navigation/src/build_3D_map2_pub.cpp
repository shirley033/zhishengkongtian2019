...
build_3D_map2::build_3D_map2()
{
  points_sub = nh.subscribe <sensor_msgs::PointCloud2> ("/velodyne_points", 1, &build_3D_map2::cloud_cb,this);
  uav_locat_sub = nh.subscribe <nav_msgs::Odometry> ("/odom", 1, &build_3D_map2::uav_loc_cb,this);
...
void build_3D_map2::cloud_cb (const sensor_msgs::PointCloud2ConstPtr& input) 
{
  // C0-update
...
void build_3D_map2::uav_loc_cb(const nav_msgs::Odometry::ConstPtr& uav_locat_msg)
{
