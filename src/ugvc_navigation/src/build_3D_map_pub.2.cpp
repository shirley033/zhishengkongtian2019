...
void build_3D_map::cloud_cb (const sensor_msgs::PointCloud2ConstPtr& input) 
{
  ...
  if(window_average_vv<52 && window_average_vv>48)
  {
    if(obstacle_front_map.maparry[uu_wall_min+49*globalMapWidth+7*globalMapLongth*globalMapLongth]==0 && 
      obstacle_front_map.maparry[uu_wall_min+51*globalMapWidth+7*globalMapLongth*globalMapLongth]==0 &&
      obstacle_front_map.maparry[uu_wall_min+49*globalMapWidth+10*globalMapLongth*globalMapLongth]==0 &&
      obstacle_front_map.maparry[uu_wall_min+51*globalMapWidth+10*globalMapLongth*globalMapLongth]==0
    )
    {
  ...
  flight_command_msg.front_wall_distance=uu_wall_min;
  if(uu_wall_min-last_wall_distance>5);
  {
    num_window_passed++;
    flight_command_msg.num_window_passed=num_window_passed;
  }
  last_wall_distance=uu_wall_min;
