...
void build_3D_map::cloud_cb (const sensor_msgs::PointCloud2ConstPtr& input) 
{
  ...
  try{
    //  ROS_INFO("SSS");
      plistener.waitForTransform("/odom", "/world",
                                  ros::Time::now(), ros::Duration(10));
      plistener.lookupTransform("/odom", "/world",
  ...
  for(size_t ww_temp=0; ww_temp<globalMapHeight; ww_temp++)
  {
    ...
    for(size_t vv_temp=0; vv_temp<globalMapLongth-10; vv_temp++) //vv_temp设置为了防止数组越界
    {
      ...
      if(obstacle_front_map.maparry[uu_wall_start+vv_temp*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1) //找到当前的障碍
      {
        ...
        ( obstacle_front_map.maparry[uu_wall_start+(vv_temp+7)*globalMapWidth+ww_temp*globalMapLongth*globalMapLongth] == 1 ||
      ...
      if(break_start_index!=0)
      {
        ...
        if(vv_temp >= break_start_index && vv_temp <=  break_stop_index)
          ...
          size_t temp_v=0;
          //ROS_INFO("test3");
          for(temp_v;temp_v<16 && window_vv_value[temp_v]!=0;temp_v++)
          {//ROS_INFO("test4");
  ...
  //wall reach or not
  if(current_wall_distance<10 && current_wall_distance>=8)
  {
    flight_command_msg.front_wall_reach=true;  
    flight_command_msg.front_wall_too_near=false;
  }
  else if(current_wall_distance<=7 && current_wall_distance>0)
  {
  ...
  if(obstacle_front_map.maparry[uu_wall_start+vv_uav*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 && 
    obstacle_front_map.maparry[uu_wall_start+(vv_uav-1)*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav+1)*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav-2)*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 && 
    obstacle_front_map.maparry[uu_wall_start+(vv_uav+2)*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+vv_uav*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth]==0 && 
    obstacle_front_map.maparry[uu_wall_start+(vv_uav-1)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav+1)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav-2)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth]==0 && 
    obstacle_front_map.maparry[uu_wall_start+(vv_uav+2)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav-1)*globalMapWidth+(ww_uav-1)*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav+1)*globalMapWidth+(ww_uav-1)*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav-2)*globalMapWidth+(ww_uav-1)*globalMapLongth*globalMapLongth]==0 && 
  ...
  {
    if(obstacle_front_map.maparry[uu_wall_start+(vv_uav-1)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth]==0 &&
      obstacle_front_map.maparry[uu_wall_start+(vv_uav+1)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth]==0 &&
      obstacle_front_map.maparry[uu_wall_start+(vv_uav-2)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth]==0 && 
      obstacle_front_map.maparry[uu_wall_start+(vv_uav+2)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth]==0 &&
      obstacle_front_map.maparry[uu_wall_start+(vv_uav-1)*globalMapWidth+(ww_uav-1)*globalMapLongth*globalMapLongth] &&
      obstacle_front_map.maparry[uu_wall_start+(vv_uav+1)*globalMapWidth+(ww_uav-1)*globalMapLongth*globalMapLongth] &&
      obstacle_front_map.maparry[uu_wall_start+(vv_uav-2)*globalMapWidth+(ww_uav-1)*globalMapLongth*globalMapLongth] && 
      obstacle_front_map.maparry[uu_wall_start+(vv_uav+2)*globalMapWidth+(ww_uav-1)*globalMapLongth*globalMapLongth] 
      )
      action_command_msgs.data=DOWN;
    else if(obstacle_front_map.maparry[uu_wall_start+(vv_uav-1)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth] &&
      obstacle_front_map.maparry[uu_wall_start+(vv_uav+1)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth] &&
      obstacle_front_map.maparry[uu_wall_start+(vv_uav-2)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth] && 
      obstacle_front_map.maparry[uu_wall_start+(vv_uav+2)*globalMapWidth+(ww_uav+1)*globalMapLongth*globalMapLongth] &&
      obstacle_front_map.maparry[uu_wall_start+(vv_uav-1)*globalMapWidth+(ww_uav-1)*globalMapLongth*globalMapLongth] ==0 &&
