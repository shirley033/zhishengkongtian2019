...
void build_3D_map::cloud_cb (const sensor_msgs::PointCloud2ConstPtr& input) 
{
  ...
  current_wall_distance=uu_wall_start-50;
  ...
  if(obstacle_front_map.maparry[uu_wall_start+vv_uav*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 && 
    ...
    obstacle_front_map.maparry[uu_wall_start+(vv_uav+2)*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav-3)*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav+3)*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+(vv_uav-4)*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 && 
    obstacle_front_map.maparry[uu_wall_start+(vv_uav+4)*globalMapWidth+ww_uav*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+vv_uav*globalMapWidth+(ww_uav-3)*globalMapLongth*globalMapLongth]==0 &&
    obstacle_front_map.maparry[uu_wall_start+vv_uav*globalMapWidth+(ww_uav+2)*globalMapLongth*globalMapLongth]==0 
  )
  {
    ...
    else if(flight_command_msg.front_wall_reach)
    {
      ...
      else 
      {
        if(window_average_vv>=49 && window_average_vv<=51)
        {
          ...
          {
            if(obstacle_front_map.maparry[uu_wall_start+vv_uav*globalMapWidth+w*globalMapLongth*globalMapLongth]==0)
              window_up++;
            else
            {
              if(window_up>0)
